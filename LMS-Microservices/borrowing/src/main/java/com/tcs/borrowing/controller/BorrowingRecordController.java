...
public class BorrowingRecordController {
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public BorrowingRecord getBorrowerById(@PathVariable Long id) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public BorrowingRecord updateBorrower(@PathVariable Long id, @RequestBody BorrowingRecord borrower) {
